...
const Home = () => {
  	return (
    		<div className={styles.home}>
      			<img className={styles.dashbodeImgIcon} alt="" src="/images/dashbode_img.png" />
      			...
      			<div className={styles.leftNavi}>
        				...
        				<div className={styles.pageSelector}>
          					<img className={styles.selector1Icon} alt="" src="/images/selector1.svg" />
        				...
        				<img className={styles.signOutImgIcon} alt="" src="/images/sign-out_img.png" />
        				<img className={styles.loginImgIcon} alt="" src="/images/login_img.png" />
        				<img className={styles.roadImgIcon} alt="" src="/images/road_img.png" />
        				<img className={styles.boardImgIcon} alt="" src="/images/board_img.png" />
      			...
      			<div className={styles.topNavi}>
        				...
        				<div className={styles.logo}>
          					<img className={styles.logoImgIcon} alt="" src="/images/logo_img.png" />
